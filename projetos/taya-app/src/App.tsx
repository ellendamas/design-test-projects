  ...
  return (
    <SubPageLayout title="Crédito com desconto em folha">
      ...
      <div className="mb-5 rounded-2xl bg-white p-4 shadow-sm border border-border">
        <div className="mb-3 flex items-center justify-between"><h3 className="text-sm font-bold text-[#D94E28]">Parcelas</h3><span className="text-xs text-[#D94E28]">{contrato.totalParcelas} parcelas</span></div>
        <div className="grid grid-cols-2 gap-3">
