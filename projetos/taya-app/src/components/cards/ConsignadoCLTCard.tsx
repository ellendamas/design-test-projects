  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-4">
      <div className="flex items-center gap-2">
        <Briefcase size={20} className="text-[#E8590A]" />
        <span className="inline-flex items-center rounded-full bg-orange-100 px-2.5 py-0.5 text-xs font-medium text-[#E8590A]">
          Onda 1
        </span>
      </div>
      ...
      <div className="mt-3 border-t border-border pt-3">
        <Link
          to="/consignado-clt"
          className="inline-flex items-center gap-1 text-sm font-medium text-[#E8590A] transition-colors hover:text-[#d04e08]"
        >
